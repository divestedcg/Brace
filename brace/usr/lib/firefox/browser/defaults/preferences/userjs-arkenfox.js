...
pref("accessibility.force_disabled", 1); //MULL-COMMENT_ME
...
pref("network.cookie.cookieBehavior", 5); // [DEFAULT: 5 FF103+] //BRACE-UNCOMMENTED: strict cannot be set on first launch, use custom + enterprise policy instead //MULL-MODIFY_ME: set to 1 for FPI
...
pref("browser.newtabpage.activity-stream.feeds.section.topstories", false); // Recommended by Pocket //BRACE-UNCOMMENTED: unwanted
pref("browser.newtabpage.activity-stream.section.highlights.includePocket", false); //BRACE-UNCOMMENTED: unwanted
...
pref("browser.newtabpage.activity-stream.asrouter.userprefs.cfr.features", false); // disable CFR [FF67+]
   ...
   // pref("browser.sessionstore.interval", 30000); // minimum interval between session save operations
