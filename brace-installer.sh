...
category='Internet';
	baseIncluded=true;
	packagesArch='firefox firefox-extension-https-everywhere firefox-ublock-origin chromium liferea';
	packagesDebian='firefox-esr webext-https-everywhere webext-ublock-origin chromium liferea';
	packagesFedora='firefox mozilla-https-everywhere mozilla-ublock-origin chromium liferea';
